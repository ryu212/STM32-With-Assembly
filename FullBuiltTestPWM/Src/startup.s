...
clear_bss_loop:
	cmp r0, r1
	itt lt                  // Bắt đầu IT block (If-Then block) với điều kiện lt
	strlt r2, [r0], #4      // Lưu 0 vào [r0] và tăng r0 nếu điều kiện lt thỏa mãn
	addlt r0, r0, #4        // Tăng r0 nếu điều kiện lt thỏa mãn
	blt clear_bss_loop      // Quay lại vòng lặp nếu r0 < r1
*/
